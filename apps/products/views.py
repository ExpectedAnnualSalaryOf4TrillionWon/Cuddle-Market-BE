...
from .serializers import ProductSerializer, ProductImageSerializer, ProductLikeSerializer
...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    def upload_images(self, request, pk=None):
        ...
        for idx, file in enumerate(files):
            ProductImage.objects.create(product=product, image_url=file, image_order=idx)
